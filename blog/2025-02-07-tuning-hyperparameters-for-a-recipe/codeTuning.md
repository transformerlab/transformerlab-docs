...
This was vital for spotting issues not always reflected in quantitative metrics. For instance, the base model tended to produce repetitive, nonsensical output 
<img src={require('./baseModelOutput.png').default} width="400" />
, a problem significantly reduced through fine-tuning. Our final model consistently generated well-formed, plausible Python.
